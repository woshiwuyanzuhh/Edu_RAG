...
DOCUMENT_TYPES: list[dict[str, str]] = [
    ...
    {
        "key": DocumentType.TECH,
        "label": "技术文档",
        "description": "IT/编程/软件手册 — 过滤代码行号、shell 提示符、TODO 注释",
    },
    {
        "key": DocumentType.MEDICAL,
        "label": "医疗健康",
        "description": "医学文献、健康科普 — 过滤免责声明、医院信息、广告",
    },
    {"key": DocumentType.LEGAL, "label": "法律法规", "description": "法条、判例、合同 — 过滤页眉页脚、司法解释水印"},
    {
        "key": DocumentType.FINANCE,
        "label": "金融财经",
        "description": "研报、财报、理财 — 过滤风险提示、免责声明、股票代码刷屏",
    },
    {"key": DocumentType.NEWS, "label": "新闻资讯", "description": "新闻报道、资讯 — 过滤版权声明、记者署名、编辑信息"},
    {
        "key": DocumentType.LITERATURE,
        "label": "文学作品",
        "description": "小说、散文、诗歌 — 过滤 OCR 噪声、章节编号噪声，保留对话",
    },
    {
        "key": DocumentType.BUSINESS,
        "label": "商业管理",
        "description": "商业报告、管理文档 — 过滤 PPT 页码、机密水印、页眉页脚",
    },
]
